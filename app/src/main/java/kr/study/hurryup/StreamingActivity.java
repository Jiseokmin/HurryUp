...
public class StreamingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        xWalkWebView.load("http://"+IP_ADDRESS+":8080/stream/video.mjpeg",null);
        // xWalkWebView.loadUrl("http://192.168.0.23:8080/stream/video.mjpeg");

        XWalkPreferences.setValue(XWalkPreferences.REMOTE_DEBUGGING, true);

        txtv_response = (TextView) findViewById(R.id.txtv_responseText);
    ...
    public class MyClientTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            txtv_response.setText(response);
